...
e2e-item1 = Argon2id(password, salt, m_cost=19456, t_cost=2) → کلید اصلی ۳۲ بایت
...
e2e-item4 = فایل‌های >۶۴KB به تکه‌های ۶۴KB تقسیم می‌شوند
e2e-item5 = سرور هرگز رمز عبور یا متن اصلی شما را نمی‌بیند
...
self-destruct-desc = شما عمر Paste خود را کنترل می‌کنید. زمان حیات (TTL) و حداکثر تعداد بازدید را تعیین کنید.
