...
pub fn Navbar() -> Element {
    ...
    let home_cls = format!("px-3 py-1.5 text-sm font-medium relative transition-colors after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:bg-accent after:transition-all duration-200 {}", link_classes(current_route == Route::Home {}));
    let how_cls = format!("px-3 py-1.5 text-sm font-medium relative transition-colors after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:bg-accent after:transition-all duration-200 {}", link_classes(current_route == Route::HowItWorks {}));
    let changelog_cls = format!("px-3 py-1.5 text-sm font-medium relative transition-colors after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:bg-accent after:transition-all duration-200 {}", link_classes(current_route == Route::Changelog {}));
